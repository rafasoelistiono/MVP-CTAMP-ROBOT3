...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Write phase configs without MuJoCo execution")
...
def main() -> int:
    ...
    output = args.output or args.log_dir / f"stacking_wall_world_v2_{time.strftime('%Y%m%d_%H%M%S')}"
